                        ...
                        <div class="modal-body">
                          ...
                          <div class="form-group row">
                            <div class="col-md-6">
                              ...
                              <div class="mt-1">
                                <?php
                                $file_materi = $list_bimtek_berkas[$value->id]->file_materi;
                                if($file_materi != NULL) { ?>
                                <a href="<?= base_url().'uploads/bimtek/'.$file_materi ?>" target="_blank">                              
                                    Lihat File Materi                         
                                </a>
                                <?php } else { ?>
                                <a>                              
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="mt-1">
                                <?php
                                $sertifikat = $list_bimtek_hasil[$value->id]->nama_serti;
                                if($sertifikat != NULL) {
                                ?>
                                <a href="<?= base_url().'uploads/bimtek/'.$sertifikat ?>" target="_blank">                              
                                    Lihat Sertifikat                         
                                </a>
                                <?php } else { ?>
                                <a>                              
