                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="d-flex flex-column align-items-center text-center">
                                        ...
                                        <div class="mt-3">
                                            <h4><?= $mutasi->pegawai_nip .' - '. $mutasi->pegawai_nama ?></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <h4 class="card-title">File Surat Keputusan <?= $mutasi->jenis_mutasi ?></h4>
                                    <a class="w-100" href="<?= base_url() . 'uploads/' . $mutasi->file_mutasi ?>" target="_blank">
