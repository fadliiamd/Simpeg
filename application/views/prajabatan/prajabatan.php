                          ...
                          <form action="<?= base_url(); ?>surat/update" method="post" class="forms-sample" enctype="multipart/form-data">
                            <div class="modal-body">
                              ...
                              <div class="form-group row">
                                ...
                                <?php if($value->jenis_kegiatan == 'prajabatan') { ?>
                                <div class="col-md-6">
                                  <label for="jenis_prajabatan">Jenis Prajabatan</label>
                                  <input type="text" class="form-control" id="jenis_prajabatan" value=<?=ucwords($value->jenis_prajabatan) ?> disabled>
                                </div>
                                <?php } ?>
                              </div>
                              <div class="form-group">
