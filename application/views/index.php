      ...
      <div class="col-12 col-xl-4">
        ...
        <div class="dropdown flex-md-grow-1 flex-xl-grow-0">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuDate2">
            <a class="dropdown-item" href="<?= base_url(); ?>assets/#">January - March</a>
            <a class="dropdown-item" href="<?= base_url(); ?>assets/#">March - June</a>
            <a class="dropdown-item" href="<?= base_url(); ?>assets/#">June - August</a>
            <a class="dropdown-item" href="<?= base_url(); ?>assets/#">August - November</a>
          </div>
        </div>
        </div>
      </div>
  ...
  <div class="col-md-6 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <a href="<?= base_url(); ?>assets/#" class="text-info">View all</a>
        </div>
        <p class="font-weight-500">The total number of sessions within the date range. It is the period time a user is actively engaged with your website, page or app, etc</p>
    ...
    <div class="card position-relative">
      <div class="card-body">
        <div id="detailedReports" class="pt-2 carousel slide detailed-report-carousel position-static" data-ride="carousel">
          ...
          <a class="carousel-control-prev" href="<?= base_url(); ?>assets/#detailedReports" role="button" data-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="sr-only">Previous</span>
          </a>
          <a class="carousel-control-next" href="<?= base_url(); ?>assets/#detailedReports" role="button" data-slide="next">
