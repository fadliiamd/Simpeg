                            ...
                            <div class="form-group row">
                              <div class="col-md-6">
                                ...
                                <div class="mt-1">
                                  ...
                                  <a href="<?= base_url().'uploads/'.$list_diklat_berkas[$value->id]->file_materi ?>" target="_blank">                              
                                      Lihat File Materi                         
                                  </a>
                                  <?php } else { ?>
                                  <a>                              
                              ...
                              <div class="col-md-6">
                                ...
                                <div class="mt-1">
                                  ...
                                  if(isset($list_diklat_hasil[$value->id])) {
                                  ?>
                                  <a href="<?= base_url().'uploads/'.$list_diklat_hasil[$value->id]->nama_serti ?>" target="_blank">                              
                                      Lihat Sertifikat                         
                                  </a>
                                  <?php } else { ?>
                                  <a>                              
