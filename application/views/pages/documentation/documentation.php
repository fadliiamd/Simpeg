              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-12 pt-5">
                    <a class="btn btn-primary" href="<?= base_url();?>"><i class="ti-home mr-2"></i>Back to home</a>
                  </div>
                </div>
...
<script src="<?= base_url();?>assets/js/codeEditor.js"></script>
<script src="<?= base_url();?>assets/js/tabs.js"></script>
<script src="<?= base_url();?>assets/js/tooltips.js"></script>
<script src="<?= base_url();?>assets/js/documentation.js"></script>
