			...
			<div class="row">
				<div class="col-md-7">
					<div class="card-body">
						...
						<div
							class="mt-4 template-demo d-flex justify-content-between flex-nowrap"
						>
							<button
								type="button"
		...
		<div class="card">
			<div class="card-body">
				...
				<div class="template-demo">
					...
					<button
						type="button"
						class="btn btn-social-icon-text btn-dribbble"
					>
						<i class="ti-dribbble"></i>Dribbble
					</button>
					<button
						type="button"
						class="btn btn-social-icon-text btn-linkedin"
					>
