    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <p class="pl-1 text-light bg-dark">.text-light</p>
            <p class="text-secondary">.text-secondary</p>
            <p class="text-dark">.text-dark</p>
            <p class="text-muted">.text-muted</p>
            <p class="pl-1 text-white bg-dark">.text-white</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col-md-4 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <div class="media">
          <i class="mr-3 ti-world icon-md text-info d-flex align-self-start"></i>
  ...
  <div class="col-md-4 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <div class="media">
          <i class="mr-3 ti-world icon-md text-info d-flex align-self-center"></i>
          <div class="media-body">
            <p class="card-text">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque.</p>
          </div>
        </div>
  ...
  <div class="col-md-4 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <div class="media">
          <i class="mr-3 ti-world icon-md text-info d-flex align-self-end"></i>
          <div class="media-body">
            <p class="card-text">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque.</p>
          </div>
        </div>
  ...
  <div class="col-md-6 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <p>
          It is a long <mark class="text-white bg-warning">established</mark> fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution
        </p>
      </div>
    </div>
  </div>
