...
class Mutasi extends Roles {
    ...
    public function sendmail()
    {
        ...
        $config = [
            ...
            'smtp_user' => 'nuno.alwi.tif420@polban.ac.id',  // Email gmail
            'smtp_pass'   => 'Wom30763',  // Password gmail
            'smtp_crypto' => 'ssl',
            'smtp_port'   => 465,
            'crlf'    => "\r\n",
            'newline' => "\r\n"
        ...
        $this->email->from('nuno.alwi.tif420@polban.ac.id', 'Nuno');

        // Email penerima
        $this->email->to('nunoalwi@gmail.com'); // Ganti dengan email tujuan
