...
class Account extends Roles
{
    ...
    public function profile_pegawai($id)
    {
        ...
        $bimtek = $this->bimtek_model->get_one_join_limit([
            'bimtek.pegawai_nip' => $id
        ], 5);
        $prajabatan = $this->prajabatan_model->get_one_join_limit([
            'prajabatan.pegawai_nip' => $id
        ], 5);
    ...
    public function update_profile_pegawai()
    {
        //form validation
        //validation form
        $this->load->library('form_validation');
        ...
        //update everything change
        $delete = $this->pegawai_model->update_profile_one($this->input->post('nip_old'));
        if ($delete) {
